...
public final class SimpleGUI {
    ...
    private final Controller ctl = new ControllerImpl();
    private final JPanel mainPanel = new JPanel(new BorderLayout());
    private final JTextField textField = new JTextField("Insert the Text below....");
    private final JTextArea textArea = new JTextArea();
    private final JButton historyButton = new JButton("Show history [Push]");
    private final JButton printButton = new JButton("Print [Push]");
    ...
    public SimpleGUI() {
        ...
        historyButton.addActionListener(e -> {
            System.out.println(ctl.getHistory());
        });
        /*
